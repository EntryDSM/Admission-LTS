...
const SelectAdditionalPoint = ({ title, name, writeGradeElement, setWriteGradeElement }: ISelectAdditional) => {
  ...
  return (
    <_Wrapper>
      ...
      <_Buttons>
        <_Button key={'O'} onClick={() => onClick(true)} isClick={isClickChecker(true)}>
          O
        </_Button>
        <_Button key={'X'} onClick={() => onClick(false)} isClick={isClickChecker(false)}>
          X
        </_Button>
      </_Buttons>
    </_Wrapper>
